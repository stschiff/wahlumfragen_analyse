function politische_stimmung_chart(svg) {
  ...
  var iOptionList = ["Aus", "Alle", "Allensbach", "Emnid", "FgWahlen", "Forsa", "GMS", "InfratestD", "Insa"];
  ...
  d3.tsv("data/posterior.txt", function(post_error, raw_data_post) {
    d3.tsv("data/joinedPoll.txt", function(poll_error, raw_data_poll) {
  ...
  function brushed() {
    ...
    focus.selectAll(".areaPlot").attr("d", function(d) {return area(d.values);});
